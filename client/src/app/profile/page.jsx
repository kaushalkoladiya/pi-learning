...
import {
  Container, TextField, Button, Typography, Box, MenuItem, Select, InputLabel, FormControl, Avatar, Grid, Paper
} from '@mui/material';
      ...
      <Paper elevation={3} sx={{ p: 4, mt: 4, backgroundColor: '#f5f5f5' }}>
        ...
        <Box component="form" onSubmit={handleSubmit} noValidate>
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth required error={!!errors.department_code}>
          ...
          <Box mt={4}>
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth required error={!!errors.province_code}>
